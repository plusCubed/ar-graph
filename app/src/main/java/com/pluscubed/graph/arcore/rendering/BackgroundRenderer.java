...
public class BackgroundRenderer {
    ...
    // Shader names.
    private static final String VERTEX_SHADER_NAME = "arcore/shaders/screenquad.vert";
    private static final String FRAGMENT_SHADER_NAME = "arcore/shaders/screenquad.frag";
